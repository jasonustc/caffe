...
class DropoutLayer : public NeuronLayer<Dtype> {
 public:
   ...
   *     Sets the probability @df$ p @f$ that any given unit is dropped.
   */
 ...
 protected:
  ...
  /// uniform and gaussian distribution requires float value
  ...
  //the interval of uniform distribution [a_, b_]
  Dtype a_;
  Dtype b_;
  //the average and standard deviation of gaussian distribution
  Dtype mu_;
  Dtype sigma_;
};
