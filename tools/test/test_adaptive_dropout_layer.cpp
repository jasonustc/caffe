	...
	public: 
	 ...
	 protected:
		void SetUp(){
			...
			//set layer parameter
			layer_param_.mutable_adaptive_dropout_param()->mutable_weight_filler()->set_type("constant");
			layer_param_.mutable_adaptive_dropout_param()->mutable_weight_filler()->set_value(0.25);
